var defaultMemorizer = require('./memorizer');

module.exports = function (memorizer) {

  var uid = {

    // Remember used strings.
    memory: memorizer || Object.create(defaultMemorizer),
